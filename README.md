...
This toolchain must be built on `win32`-`msys2`, and targets `mingw`(`32`|`64`) for >= Windows XP. Run `python build-either-w64-mingw32.py` to build your preferred toolchain.
